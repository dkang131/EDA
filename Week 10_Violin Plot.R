...
# Another color palettes
dp + scale_fill_brewer(palette="YIOrRd") + theme_minimal()
dp + scale_fill_brewer(palette="RdGy") + theme_minimal()
dp + scale_fill_brewer(palette="PRGn") + theme_minimal()
dp + scale_fill_brewer(palette="Pastel1") + theme_minimal()
